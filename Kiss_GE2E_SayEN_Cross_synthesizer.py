...
cross_sample_dir = '/ceph/home/hujk17/Tuned-GE2E-SayEN-EarSpeech/samples_Cross'



enc_model_fpath = None # GE2E 的模型路径写死在 Extractor 中
syn_model_fpath = '/ceph/home/hujk17/Tuned-GE2E-SayEN-EarSpeech/synthesizer/saved_models/Kiss/Kiss_195k.pt'
...
def main():
    ...
    for i, wav_name in enumerate(wav_list):
        ...
        for j, text in enumerate(input_text):
            ...
            _wav_pre = mel2wav(mel, wav_name_path=os.path.join('log_Kiss_GE2E_SayEN_syn_wavs_Cross', 'spk_' + str(i) + '_' + str(j) + '_pre.wav'))
            _wav_target = mel2wav(mel_reference, wav_name_path=os.path.join('log_Kiss_GE2E_SayEN_syn_wavs_Cross', 'spk_' + str(i) + '_' + str(j) + '_reference.wav'))
            # break
            # return
